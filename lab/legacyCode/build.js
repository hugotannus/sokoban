$(document).ready(function(){
      ...
      var that = {
        ...
        update : function(){
          ...
          for(var i=0,l=that.blocks.length;i<l;i++)
            that.draw(that.blocks[i], "rgb(200, 220, 240)");
  
          for(var i=0,l=that.goals.length;i<l;i++)
            that.draw(that.goals[i], "rgb(240, 144, 0)");
  
          that.draw(that.player, "rgb(96, 192, 96)");
        },
          ...
          $(document).on("keydown", function(e){
            if(e.keyCode >= 37 && e.keyCode <= 40){
              ...
              if(nextMoveEmpty(that.player, that.direction)){
                ...
                that.draw(that.player, "rgb(96, 240, 96)");
    ...
    var level1 = {
      ...
      goals  : [{p:1,d:"CERCOMP",x:4,y:4},{x:5,y:5}],
      walls  : [{x:2,y:3},{x:4,y:2},{x:5,y:4},{x:3,y:5}]
    }
